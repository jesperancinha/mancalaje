...
class GameServiceImpl(
    ...
    override fun createNewBoard(player: Player): Board? {
        val board = Board()
    ...
    override fun sowStonesFromPit(player: Player, pit: Pit, board: Board?): Board? {
    ...
    override fun joinPlayer(playerTwo: Player, board: Board?): Board? {
