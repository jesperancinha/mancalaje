                ...
                <Grid item xs={XS_COL_SPAN}>
                    ...
                    <AppBar title={"Home Mancala Je"} position="relative">
                        ...
                        <Typography component="p">
                            Demo version: Please note that this app will be updated with no warning on needed occasions
                            on periods from 19h to 23h CET/CEST depending on current DST.
                            Your current game in progress will be removed, but your user will not. This means that you
                            can login again, create rooms and play online again once the services are back online.
                            In this current version you cannot change password. You will in future versions.
                            Remember that your user will be available for a maximum idle period of 5 hours and that
