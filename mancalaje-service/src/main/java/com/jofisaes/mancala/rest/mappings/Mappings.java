...
public class Mappings {
    ...
    public static final String MANCALA_ROOMS = MANCALA + "rooms";
    public static final String MANCALA_PUBLIC_USERS = MANCALA + "users";
    public static final String MANCALA_ADMIN_USERS = MANCALA + "admin";
}
